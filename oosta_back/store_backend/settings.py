...
SECRET_KEY = 'django-insecure-u-b0n-#g^!tc#^ca&r--ifpsz&chvue_4)^6lv1-nqbx(s_-ud'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Backend API for selling digital accounts',
    'VERSION': '1.0.0',
...
ZARINPAL_MODE = os.getenv("ZARINPAL_MODE", "sandbox")  # sandbox | production
